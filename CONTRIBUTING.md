# Contributing to `@semore/mcp-adapter`
...
3. Add or update Vitest tests. Keep coverage of `listTools`, `callTool`, and
   `handleJsonRpc` paths.
...
<semore.hq@gmail.com> with the subject line `SECURITY: mcp-adapter`.
